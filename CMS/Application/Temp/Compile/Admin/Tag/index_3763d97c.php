...
<div class="wrap">
    <table class="table hd-table-list">
        ...
        <tbody>
            ...
            <tr>
                <td width="30" align="center"><?php echo $v['tid'];?></td>
                <td align="center"><?php echo $v['tagname'];?></td>
                <td width="200" align="center">
                    <a href="<?php echo U('Admin/Tag/edit',array('tid'=>$v['tid']));?>" class="btn btn-warning btn-xs" >编辑</a>
                    <a href="javascript:del(<?php echo $v['tid'];?>);" class="btn btn-danger btn-xs">删除</a>
                </td>
            </tr>
            <?php }?>   
        </tbody>
    ...
    function del(id) {
        hd_modal({
            ...
            success: function () {//点击确定后的事件
                location.href="<?php echo U('Admin/Tag/del');?>" + "&tid=" + id;
            },
