...
<div class="nav">
    ...
    <!--头部右侧导航-->
    <div class="r_menu">
        您好 ，<strong><span style="color:orange;"><?php echo $hd['session']['aname'];?></span></strong> &nbsp;&nbsp;<span>|</span>
        <a href="<?php echo U('Admin/Login/Logout');?>" target="_self">[ 退出 ]</a>
        <span>|</span>
        <a href="<?php echo U('Index/muban/index');?>" target="_blank">前台首页</a>
    </div>
    <!--头部右侧导航-->
</div>
<!--左侧导航-->
        ...
        <div class="nid_0">
            <dl>
                <div>
                    ...
                    <dd>
                        <a href="<?php echo U('Admin/Category/add');?>" class="action" >添加分类</a>
                    </dd>
                </div>
                <div>
                    <dt>文章管理</dt>
                    <dd>
                        <a href="<?php echo U('Admin/Article/index');?>">文章列表</a>
                    </dd>
                    <dd>
                        <a href="<?php echo U('Admin/Article/add');?>">添加文章</a>
                    </dd>
                    <dd>
                        <a href="<?php echo U('Admin/Article/recycle');?>">回收站</a>
                    </dd>
                </div>
                <div>
                    <dt>标签管理</dt>
                    <dd>
                        <a href="<?php echo U('Admin/Tag/index');?>">标签列表</a>
                    </dd>
                    <dd>
                        <a href="<?php echo U('Admin/Tag/add');?>">添加标签</a>
                    </dd>
                </div>
                <div>
                    <dt>静态管理</dt>
                ...
                <div>
                     <dt>站点配置</dt>
                     <dd>
                        <a href="<?php echo U('Admin/Webset/index');?>">站点配置</a>
                    </dd>
                </div>
                <div>
                     <dt>站点导航</dt>
                     <dd>
                        <a href="<?php echo U('Admin/Flink/index');?>">友情链接</a>
                        <a href="<?php echo U('Admin/Flink/add');?>">添加友链</a>
                    </dd>
                </div>
                <div>
                    <dt>数据备份</dt>
                     <dd>
                        <a href="<?php echo U('Admin/Backup/list');?>">备份列表</a>
                    </dd>
                    <dd>
                        <a href="<?php echo U('Admin/Backup/execute');?>">数据备份</a>
                    </dd>
                </div>
                <div>
                    <dt>评论管理</dt>
                ...
                <div>
                    <dt>用户管理</dt>
                     <dd>
                        <a href="<?php echo U('Admin/User/index');?>">前台用户</a>
                        <a href="<?php echo U('Admin/User/admin');?>">后台用户</a>
                    </dd>
                </div>
             </dl>
        </div>
