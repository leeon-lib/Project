...
<div class="wrap">
    <table class="table table-bordered hd-table-list">
        ...
        <tr>
            ...
            <td width="130" align="center">属性</td>
        ...
        <?php foreach ($info as $k=>$v){?>
            ...
            <td width="130" align="center"><?php echo $v['attr'];?></td>
            <td width="180" align="center"><?php echo date('Y-m-d H:i:s',$v['sendtime']);?></td>
            ...
            <td width="150" align="center">
                <a href="<?php echo U('Admin/Article/edit',array('aid'=>$v['aid']));?>" class="btn btn-warning btn-xs">编辑</a>
    ...
    function del(id) {
        hd_modal({
            ...
            success: function () {//点击确定后的事件
                location.href="<?php echo U('Admin/Article/del');?>" + "&aid=" + id;
            },
