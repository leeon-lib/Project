...
<head>
	...
	<script src="http://127.0.0.1/Project/jumei/Static/Org/jquery-1.7.2.min.js"></script>
	<script src="http://127.0.0.1/Project/jumei/Static/Org/cal/lhgcalendar.min.js"></script>
</head>
<body>
	<div class="submenu">
		<div class="left">
			...
			<tbody>
				<?php foreach ($productList as $k=>$v){?>
					<tr>
						...
						<td align="center">
							<?php if (empty($v['pic'])){ ?>
								<img src="http://127.0.0.1/Project/jumei/Static/Images/default_s.gif" alt="" width="60px">
							<?php }else{ ?>
								<img src="http://127.0.0.1/Project/jumei/Upload/Product/<?php echo $v['pic'];?>" alt="" width="60px">
							<?php } ?>
						</td>
