...
<head>
	...
	<link rel="stylesheet" href="http://127.0.0.1/Project/jumei/Static/Css/admin.css">
</head>
<body>
	<div class="head">
		<div class="logo">
		...
		<div class="nav">
			<ul>
				...
				<li>
					<a href="<?php echo U('Admin/Index/product');?>" target="aside">商品管理</a>
				</li>
				<li>
					<a href="<?php echo U('Admin/Index/purchase');?>" target="aside">采购管理</a>
				</li>
				<li>
					<a href="<?php echo U('Admin/Index/stock');?>" target="aside">库存管理</a>
				</li>
				<li>
					<a href="<?php echo U('Admin/Index/order');?>" target="aside">订单管理</a>
				</li>
				<li>
					<a href="<?php echo U('Admin/Index/storage');?>" target="aside">仓储管理</a>
				</li>
				<li>
