							...
							<td>
								<select name="pid">
									...
									<?php else: ?>
										...
										<?php if(is_array($deptList)): foreach($deptList as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>" <?php if($v['id'] == $oldData['department_id']): ?>selected="selected"<?php endif; ?> ><?php echo ($v["name"]); ?></option><?php endforeach; endif; endif; ?>
								</select>
							</td>
						</tr>
						<tr>
